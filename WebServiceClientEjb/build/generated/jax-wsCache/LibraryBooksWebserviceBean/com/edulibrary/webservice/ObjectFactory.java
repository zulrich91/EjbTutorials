 ...
 * generated in the com.edulibrary.webservice package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetBooks_QNAME = new QName("http://webservice.eduLibrary.com/", "getBooks");
    private final static QName _Books_QNAME = new QName("http://webservice.eduLibrary.com/", "books");
    private final static QName _GetBooksResponse_QNAME = new QName("http://webservice.eduLibrary.com/", "getBooksResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.edulibrary.webservice
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.eduLibrary.com/", name = "getBooks")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.eduLibrary.com/", name = "books")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.eduLibrary.com/", name = "getBooksResponse")
